  ...
  mermaid.initialize({
    ...
    themeVariables: dark
      ? {
          // Dark — warm tones
          primaryColor: '#3a2e28',
          primaryTextColor: '#d4d0ca',
          primaryBorderColor: '#5c4a3e',
          secondaryColor: '#2e2a22',
          secondaryTextColor: '#d4d0ca',
          secondaryBorderColor: '#4a3e34',
          tertiaryColor: '#342e26',
          tertiaryTextColor: '#d4d0ca',
          tertiaryBorderColor: '#5c4a3e',
          lineColor: '#6b5d52',
          textColor: '#d4d0ca',
          mainBkg: '#3a2e28',
          nodeBorder: '#5c4a3e',
          clusterBkg: '#2e2a22',
          clusterBorder: '#4a3e34',
          titleColor: '#ece8e2',
          edgeLabelBackground: '#242320',
          nodeTextColor: '#d4d0ca',
          background: '#1c1b19',
      ...
      : {
          ...
          primaryBorderColor: '#c4a48c',
          secondaryColor: '#faf2ec',
          secondaryTextColor: '#2c2825',
          secondaryBorderColor: '#d4bca8',
          tertiaryColor: '#f0e6dc',
          tertiaryTextColor: '#2c2825',
          tertiaryBorderColor: '#c4a48c',
          lineColor: '#a09080',
          textColor: '#2c2825',
          mainBkg: '#f5ebe4',
          nodeBorder: '#c4a48c',
          clusterBkg: '#faf5f0',
          clusterBorder: '#d4bca8',
          titleColor: '#1a1715',
          edgeLabelBackground: '#faf8f5',
          nodeTextColor: '#2c2825',
          background: '#faf8f5',
          fontFamily: 'Inter, -apple-system, sans-serif',
          fontSize: '14px',
        },
